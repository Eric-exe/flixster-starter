        ...
        <>
            ...
            <main>
                <div className="sticky-bar background-green">
                    ...
                    <BrowseMode searchMode={searchMode} apiSetFunct={setApiReqData} />

                    <SearchMode searchMode={searchMode} apiSetFunct={setApiReqData} />
                ...
                <div id="main-body">
                    <div id="movie-body" style={{ marginRight: sidebarOpened ? "35vw" : "" }}>
                        ...
                        <button className="button" id="load-button" onClick={loadMore} style={{ margin: "auto" }}>
                            Load More
                        </button>
                    </div>
                    <PersonalSidebar
            ...
            <footer className="background-green">
                <span className="margin-h">Flixster</span>
